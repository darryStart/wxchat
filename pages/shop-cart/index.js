            ...
            if (isFail) {
                ...
                wx.request({
                    ...
                    data: {
                        mod:'product',
                        act:'get_detail',
                        product_id: carShopBean.goodsId
                    },
                    success: function(res) {
                        if(res.data.code == 200){
                            ...
                            if (parseInt(info.product_num) < carShopBean.number) {
                                wx.showModal({
                                    title: '提示',
                                    content: info.product_name + ' 库存不足，请重新购买',
                                    showCancel: false
                                }) 
                                isFail = true;
                                wx.hideLoading();
                            ...
                            if (parseInt(info.product_smoney) != carShopBean.price) {
                                wx.showModal({
                                    title: '提示',
                                    content: info.product_name + ' 价格有调整，请重新购买',
                                    showCancel: false
                                }) 
                                isFail = true;
                                wx.hideLoading();
